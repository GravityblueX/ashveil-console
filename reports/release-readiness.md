...
Generated: 2026-07-19T10:02:20.244Z
...
| smoke report required gate list is well formed               | OK     | 32 required gate(s)                                                                   |
| API surface report required gate list is well formed         | OK     | 9 required gate(s)                                                                    |
| OpenAPI report required gate list is well formed             | OK     | 20 required gate(s)                                                                   |
| client API coverage report required gate list is well formed | OK     | 8 required gate(s)                                                                    |
| dependency SBOM report required gate list is well formed     | OK     | 8 required gate(s)                                                                    |
...
| release readiness gate ok values are boolean                 | OK     | 54 gate ok value(s)                                                                   |
| release readiness gate names are unique                      | OK     | 55 gate(s)                                                                            |
